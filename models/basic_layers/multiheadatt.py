...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None, decay_weight=None):
        if mask is not None:
        ...
        x, attn = self.attention.forward(query, key, value, mask=mask, decay_weight=decay_weight, dropout=self.dropout)
